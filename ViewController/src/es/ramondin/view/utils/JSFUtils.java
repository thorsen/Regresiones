...
public class JSFUtils {
    ...
    public static Object getExpressionValue(String jsfExpression)
    {
      ...
      ValueExpression ve =  getFacesContext().getApplication().getExpressionFactory().createValueExpression(getFacesContext().getELContext(),jsfExpression,Object.class);
     ...
     * @param beanName name of managed bean whit your scope
     * @return Managed object
     */
     ...
     * @param msg info message string
     */
    public static void addNotificationMessage(String msg) {
        ADFUtils.writeJavaScriptToClient("addNotificationMessage('"+msg+"','"+null+"');");
    }
     ...
     * @param msg info message string
     */
    public static void addNotificationMessage(String msg,String icon) {
        ADFUtils.writeJavaScriptToClient("addNotificationMessage('"+msg+"','"+icon+"');");
    }
  ...
  public static FacesMessage getMessageFromBundle(String bundleName,String key, FacesMessage.Severity severity) {
      ResourceBundle bundle = getBundleApp(bundleName);
      FacesMessage message = new FacesMessage(null, bundle.getString(key));
      message.setSeverity(severity);
      return message;
  }

    private static ResourceBundle getBundleApp(String nameBundle) {
    ...
    */
    ...
    /**
     *  Method that show a list of messaged in af:message with severity like popup icon
     * @param msgs
     * @param severity
     */
    public static void addFacesGlobalListMessage(List msgs, FacesMessage.Severity severity) {
        if (msgs != null && severity != null && !msgs.isEmpty()) {
            ...
            log.warning("Parameters not defined correctly.");
        }
    }
}
